...
const CareersPage = () => {
  ...
  const positions: Position[] = [
    ...
    },
    {
      ...
      mode: 'Hybrid',
      department: 'Engineering',
      description: 'Assist in performing Computational Fluid Dynamics (CFD) and Finite Element Analysis (FEA) to evaluate and optimize product designs.',
      requirements: [
  ...
  const collaborationTypes = [
    {
      ...
      description: 'Partner with us for groundbreaking research in aerospace technology. Join our network of academic institutions and research centers.',
      email: 'info@dashagriv.in',
      subject: '[Dashagriv Website] - Knowledge Partnership Inquiry'
    },
    {
      title: 'Educational Alliance',
      description: 'Create opportunities for students through internships, workshops, and collaborative projects. Help shape the future workforce.',
      email: 'info@dashagriv.in',
      subject: '[Dashagriv Website] - Educational Alliance Inquiry'
    },
    {
      title: 'Industry Collaboration',
      description: 'Form strategic partnerships to develop innovative aerospace solutions. Leverage our expertise and infrastructure for mutual growth.',
      email: 'info@dashagriv.in',
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Open Positions */}
      <section id="positions" className="py-32 bg-black border-b border-white/10">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            <div>
              <p className="eyebrow mb-4">Opportunities</p>
              <h2 className="text-4xl md:text-5xl font-display uppercase tracking-tight">Open Positions</h2>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <AnimatePresence mode="wait">
              {filteredPositions.length > 0 ? filteredPositions.map((position) => (
                ...
                >
                  <div>
                    ...
                    <div className="flex gap-4 eyebrow text-zinc-500">
                      ...
                      <span>{position.type === 'internship' ? 'Internship' : 'Full-time'}</span>
                    </div>
                  </div>
                ...
                <div className="p-12 text-center border border-white/10 text-zinc-500 font-display uppercase tracking-widest">
      ...
      {/* Collaborate */}
      <section id="collaborate" className="py-32 bg-zinc-950 border-b border-white/10">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-24">
            <p className="eyebrow mb-4">Partnerships</p>
            <h2 className="text-4xl md:text-5xl font-display uppercase tracking-tight">Collaborate With Us</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {collaborationTypes.map((collab, index) => (
              <div key={index} className="p-10 border border-white/10 bg-black flex flex-col hover:bg-zinc-900 transition-colors">
                <h3 className="text-xl font-display uppercase tracking-wide mb-6 text-white">{collab.title}</h3>
                <p className="text-zinc-400 text-sm leading-relaxed mb-10 flex-1">{collab.description}</p>
                <a
        ...
        {selectedPosition && (
          ...
          >
            <div className="bg-zinc-950 border border-white/10 p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto relative">
              ...
              <h3 className="text-3xl font-display uppercase tracking-wide mb-4 pr-12">{selectedPosition.title}</h3>
              
              <div className="flex gap-6 mb-8 eyebrow text-zinc-500 border-b border-white/10 pb-6">
                <span className="flex items-center gap-1"><MapPin className="w-3 h-3" /> {selectedPosition.location}</span>
              ...
              <div className="mb-8">
                ...
                <p className="text-zinc-300 text-sm leading-relaxed">{selectedPosition.description}</p>
              </div>
              ...
              <div className="mb-12">
                ...
                <ul className="space-y-3">
                  {selectedPosition.requirements.map((req, index) => (
                    <li key={index} className="text-zinc-300 text-sm flex gap-3">
