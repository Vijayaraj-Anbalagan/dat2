      ...
      >
        <div className="relative max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.p 
            className="text-xl text-transparent bg-clip-text bg-gradient-to-r from-black to-white mb-12 max-w-2xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="relative p-8 group">
            ...
            <div className="relative space-y-8">
              <motion.h2 
                className="text-4xl font-bold bg-gradient-to-r from-blue-400 via-violet-400 to-blue-400 bg-clip-text text-transparent"
              ...
              <div className="grid grid-cols-3 gap-6 hidden sm:grid">
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    className="group/card relative h-36 overflow-hidden"
                  >
          ...
          <motion.div 
            className="relative h-[500px] group hidden sm:block"
          ...
          >
            <div className="absolute inset-0 rounded-xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center 
                ...
                <div className="w-[300px] h-[300px] border border-blue-400/30 
                        rounded-full animate-spin-slow shadow-[0_0_15px_rgba(59,130,246,0.3)]" />
                <div className="absolute w-[200px] h-[200px] border border-violet-400/30 
                        rounded-full animate-spin-slow-reverse shadow-[0_0_15px_rgba(139,92,246,0.3)]" />
              </div>
            ...
            <div className="absolute top-0 left-0 w-20 h-20 border-l-2 border-t-2 
                      border-blue-400/40 rounded-tl-xl group-hover:border-blue-400/60 
                      transition-colors duration-300 shadow-[0_0_10px_rgba(59,130,246,0.4)]" />
            <div className="absolute bottom-0 right-0 w-20 h-20 border-r-2 border-b-2 
                      border-violet-400/40 rounded-br-xl group-hover:border-violet-400/60 
                      transition-colors duration-300 shadow-[0_0_10px_rgba(139,92,246,0.4)]" />
          </motion.div>
        </motion.div>
      </div>
    </section>
